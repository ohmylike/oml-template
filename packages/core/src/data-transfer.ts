...
import { createBundle, parseBundle, type DataBundle } from './data-bundle'
import { listSchemaTables, type DbConnectionOptions } from './schema-description'

export interface ExportDatabaseOptions extends DbConnectionOptions {
  serviceName: string
}
